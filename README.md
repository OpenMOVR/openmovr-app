...
2. **Live Mode** — Uses parquet data files in `data/`. Full interactivity with cohort filters, real-time calculations, site analytics, and patient-level data exports.
